...
ActiveRecord::Schema.define(version: 20_210_501_153_639) do
  ...
  create_table 'games', force: :cascade do |t|
    ...
    t.integer 'connected_players', default: [], array: true
  ...
  create_table 'tournament_participants', force: :cascade do |t|
    ...
    t.index %w[user_id tournament_id], name: 'index_tournament_participants_on_user_id_and_tournament_id',
                                       unique: true
  ...
  create_table 'user_ignores', force: :cascade do |t|
    ...
    t.index %w[user_id ignored_id], name: 'index_user_ignores_on_user_id_and_ignored_id', unique: true
  ...
  create_table 'war_times', force: :cascade do |t|
    ...
    t.integer 'from_max_unanswered'
    t.integer 'on_max_unanswered'
    t.bigint 'war_id'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
