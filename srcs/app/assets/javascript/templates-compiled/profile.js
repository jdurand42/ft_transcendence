...
templates['profile'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"supraDiv\">\n<div class=\"pannel\" id=\"profilePannel\"></div>\n\n\n	<div class=\"contentWrapper\">\n		<div id=\"profileSubNavBar\"></div>\n		<div id=\"profileContent\"></div>\n		<div class=\"modal validationModal\" id=\"editNicknameModal\" style=\"display: none;\">\n			<div class=\"background\"></div>\n			<div class=\"modalOpen\">\n				<div class=\"close closeModal\">\n					<img src=\"./icons/close.svg\" id=\"close\"></img>\n				</div>\n				<label class=\"label\" for=\"search\">Edit nickname</label>\n				<input class=\"textInput\" id=\"newNicknameInput\" type=\"text\" placeholder=\"New nickname\" maxlength=\"15\" for=\""
    + alias1(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"loc":{"start":{"line":16,"column":110},"end":{"line":16,"column":116}}}) : helper)))
