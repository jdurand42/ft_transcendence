...
templates['guildMembers'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	        <tr class=\"tableBoard gamerTable\" for=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"status") || (depth0 != null ? lookupProperty(depth0,"status") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"status","hash":{},"data":data,"loc":{"start":{"line":36,"column":42},"end":{"line":36,"column":52}}}) : helper)))
    + "\" id=\"pastille\"></div>\n	                    <p class=\"status\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"status") || (depth0 != null ? lookupProperty(depth0,"status") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"status","hash":{},"data":data,"loc":{"start":{"line":37,"column":39},"end":{"line":37,"column":49}}}) : helper)))
    + "</p>\n	                    <div class=\"slide-show-container\"></div>\n	                    <img src=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"slide_show") || (depth0 != null ? lookupProperty(depth0,"slide_show") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"slide_show","hash":{},"data":data,"loc":{"start":{"line":39,"column":31},"end":{"line":39,"column":45}}}) : helper)))
    + "\" class=\"slide-show\"></img>\n	                </div>\n	            </td>\n	            <td>"
    + alias4(((helper = (helper = lookupProperty(helpers,"member") || (depth0 != null ? lookupProperty(depth0,"member") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"member","hash":{},"data":data,"loc":{"start":{"line":42,"column":17},"end":{"line":42,"column":27}}}) : helper)))
    + "</td>\n	        </tr>\n";
  ...
  return "<div class=\"guildBlock\" id=\"lastWarsBlock\">\n	<div class=\"listsBoard leaderboardList\" id=\"memberGuildList\">\n	    <div class=\"nb-list nbMembers\">"
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"members") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":17,"column":3},"end":{"line":44,"column":18}}})) != null ? stack1 : "")
    + "	    </table>\n		</div>\n	</div>\n</div>\n";
},"useData":true});
})();