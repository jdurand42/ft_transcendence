...
templates['tournamentHeader'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <div class=\"create-tournament-container\">\n            <button class=\"create-new-tournament\" id=\"create-new-tournament\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"createTournament") || (depth0 != null ? lookupProperty(depth0,"createTournament") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"createTournament","hash":{},"data":data,"loc":{"start":{"line":37,"column":77},"end":{"line":37,"column":97}}}) : helper)))
    + "</button>\n        </div>\n";
  ...
  return "<div class=\"tournament-header\" id=\"tournament-header\">\n    <div class=\"winner\" id=\"winner\" style=\"display:none;\">\n        <div class=\"first-sentence\">Congratulations to "
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"tournament") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":29,"column":8},"end":{"line":33,"column":15}}})) != null ? stack1 : "")
    + "        </div>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"admin") : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":35,"column":8},"end":{"line":39,"column":15}}})) != null ? stack1 : "")
    + "        </div>\n    </div>\n</div>";
},"useData":true});
})();