...
templates['guildInvitation'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"notif guildNotif\" id=\"guildNotif"
    ...
    + " guild.</p>\n    <div class=\"buttons-notif-container\">\n        <div class=\"acceptGame-container\" id=\"acceptGame-container\">\n            <button class=\"button-notif acceptGuild\" id=\"acceptGuild\" for=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":8,"column":75},"end":{"line":8,"column":81}}}) : helper)))
    + "\">Accept</button>\n        </div>\n        <div class=\"refuseGame-container\" id=\"refuseGame-container\">\n            <button class=\"button-notif refuseGuild\" id=\"refuseGuild\" for=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":11,"column":75},"end":{"line":11,"column":81}}}) : helper)))
    + "\">Refuse</button>\n        </div>\n    </div>\n</div>";
},"useData":true});
})();