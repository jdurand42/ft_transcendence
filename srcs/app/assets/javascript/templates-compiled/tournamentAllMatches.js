...
templates['tournamentAllMatches'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <div class=\"match-done-container\">\n            <div class=\"match-done\">\n                <div class=\"image-nickname\" onclick=\"window.location='#profile/"
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"opponent1") || (depth0 != null ? lookupProperty(depth0,"opponent1") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent1","hash":{},"data":data,"loc":{"start":{"line":37,"column":52},"end":{"line":37,"column":65}}}) : helper)))
    + "</div>\n                    <div class=\"image-container\">\n                        <img class=\"image-url\" src=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"opponent2") || (depth0 != null ? lookupProperty(depth0,"opponent2") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"opponent2","hash":{},"data":data,"loc":{"start":{"line":49,"column":52},"end":{"line":49,"column":65}}}) : helper)))
    + "</div>\n                </div>\n            </div>\n"
  ...
  return "<div class=\"all-matches  matches-page\" id=\"all-matches\">\n    <div class=\"to-do-container container\" id=\"to-do-container\">\n        <div class=\"to-do title\" id=\"to-do\">To do "
    ...
    + "</div>\n        <div class=\"all-done\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"allDone") : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":33,"column":8},"end":{"line":56,"column":17}}})) != null ? stack1 : "")
    + "        </div>\n        </div>\n    </div>\n</div>";
},"useData":true});
})();