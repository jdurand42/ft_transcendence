...
templates['guild'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"supraDiv\" id=\"supraDiv\">\n	<div class=\"pannel\" id=\"guildPannel\"></div>\n	<div class=\"contentWrapper\">\n	<div class=\"buttons\">\n"
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"declareWar") : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":8,"column":2},"end":{"line":15,"column":9}}})) != null ? stack1 : "")
