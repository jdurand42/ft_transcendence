...
templates['warTimes'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "            <div class=\"war-time\" id=\""
    ...
    + "\">\n                        "
    + alias4(((helper = (helper = lookupProperty(helpers,"day") || (depth0 != null ? lookupProperty(depth0,"day") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"day","hash":{},"data":data,"loc":{"start":{"line":17,"column":24},"end":{"line":17,"column":31}}}) : helper)))
    ...
    + "\">\n                        "
    + alias4(((helper = (helper = lookupProperty(helpers,"day") || (depth0 != null ? lookupProperty(depth0,"day") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"day","hash":{},"data":data,"loc":{"start":{"line":33,"column":24},"end":{"line":33,"column":31}}}) : helper)))
    ...
    + "\" placeholder=\"MM\" maxlength=\"2\"></input>\n                <a class=\"minus-circular-container\" id=\"minus-circular-container\">\n                    <img src=\"./icons/minus-circular.svg\" class=\"minus-circular\">\n                </a>\n            </div>\n";
